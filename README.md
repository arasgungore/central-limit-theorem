...
The central limit theorem (CLT) implies that given ![sequence](https://render.githubusercontent.com/render/math?math=X_1,X_2,\ldots,X_n), a sequence of independent and identically distributed (IID) random variables with expected value ![expected_value](https://render.githubusercontent.com/render/math?math=\mu_x) and variance ![variance](https://render.githubusercontent.com/render/math?math=\sigma_x^2), the cumulative distribution function (CDF) of ![sum](https://render.githubusercontent.com/render/math?math=Z_n=\sum_{i=1}^{n}\frac{X_i-n\mu_X}{\sqrt{\left(n\sigma_X^2\right)}}) has the property ![equation](https://render.githubusercontent.com/render/math?math=\lim_{n\rightarrow\infty}{F_{Z_n}}\left(z\right)=\Phi\left(z\right)). Briefly, the theorem states that as n increases, the sum of n IID random variables converges to a [normal distribution](https://en.wikipedia.org/wiki/Normal_distribution).
